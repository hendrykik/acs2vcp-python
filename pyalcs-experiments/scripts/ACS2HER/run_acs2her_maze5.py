...
from lcs.agents.acs2her  import ACS2HER, Configuration as CFG_ACS2HER
...
def _save_experiment_json(agent, env, explore_metrics, exploit_metrics_1, exploit_metrics_2, exploit_metrics_3, data_path, explore_time, exploit_time):
    ...
    full_path = DATA_PATH + '/ACS2HER/' + data_path
...
def _run_acs2her_experiment(her_goals_number: int, er_samples: int):
...
_run_acs2her_experiment(HER_NEW_GOALS, ER_SAMPLES_NUMBER)
